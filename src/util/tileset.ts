...
export function parseTilesetFile(content: string, resref: string): TilesetInfo {
  ...
  for (let i = 0; i < tileCount; i++) {
    ...
    tiles.push({
      ...
      orientation: parseInt(s.Orientation ?? "0", 10),
      groupId: null,
      groupName: null,
    });
  }
 ...
 *
 * The tile's stored corners describe orientation 0.
 * After rotation, what was at position X is now at the rotated position.
 */
